...
QGCFlickable {
    ...
    Item {
        ...
        Column {
            ...
            QGCLabel {
                text: qsTr("加速度计 1: ") + (_activeVehicle ? _activeVehicle.vibration.clipCount1.valueString : "")
                color: textColor
            }

            QGCLabel {
                text: qsTr("加速度计 2: ") + (_activeVehicle ? _activeVehicle.vibration.clipCount2.valueString : "")
                color: textColor
            }

            QGCLabel {
                text: qsTr("加速度计 2: ") + (_activeVehicle ? _activeVehicle.vibration.clipCount3.valueString : "")
                color: textColor
            }
        }
