...
QGCView {
    ...
    readonly property string    dialogTitle:    qsTr("WIFI连接设置")
            ...
            Column {
                ...
                Rectangle {
                    ...
                    GridLayout {
                       ...
                       anchors.centerIn:                parent
                       QGCLabel {
                           text:                        qsTr("WIFI连接/无人机连接")
                           Layout.alignment:            Qt.AlignHCenter
                       }
                       QGCLabel {
                           text:                        qsTr("WIFI连接/地面站连接")
                           Layout.alignment:            Qt.AlignHCenter
                       }
                       QGCLabel {
                           text:                        qsTr("地面站/WIFI连接")
                           Layout.alignment:            Qt.AlignHCenter
                       }
                       Row {
                           spacing:                     _margins
                ...
                Row {
                    ...
                    QGCButton {
                        ...
                        MessageDialog {
                            ...
                            title:      qsTr("重启WIFI连接")
                            text:       qsTr("将重启WIFI连接以使设置生效. 确认重启?")
                            onYes: {
                                controller.reboot()
