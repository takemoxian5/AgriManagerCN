...
SetupPage {
    ...
    Component {
        ...
        Column {
            ...
            RowLayout {
                ...
                QGCButton {
                    text:       qsTr("加载常见的参数")
                    onClicked:  showDialog(applyRestartDialogComponent, qsTr("加载常见的参数"), qgcView.showDialogDefaultWidth, StandardButton.Close)
                }
            }
    ...
    Component {
        ...
        Grid {
            ...
            QGCButton {
                text:       qsTr("加载常见的参数")
                onClicked:  showDialog(selectParamFileDialogComponent, qsTr("加载常见的参数"), qgcView.showDialogDefaultWidth, StandardButton.Close)
            }
        }
    }
} // SetupPage
